# Refrence: -- https://docs.microsoft.com/en-us/azure/virtual-machines/scripts/virtual-machines-windows-powershell-sample-create-vm-from-snapshot
# Creating VM using OS Disk

$resourceGroupName ='Kalpesh-RG'

#Provide the name of the snapshot that will be used to create OS disk
$snapshotName = 'IFI-VM1_disk1_be7bb9f119e64216a7bc7eb91f267320_snapshot_150820'

#Provide the name of the OS disk that will be created using the snapshot
$osDiskName = 'IFI-VM1-Disk'

#Provide the name of an existing virtual network where virtual machine will be created
$virtualNetworkName = 'Kalpesh-RG-vnet'

#Provide the name of the virtual machine
$virtualMachineName = 'IFI-VM4'
